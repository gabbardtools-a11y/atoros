      ...
      <div className="max-w-[1100px] mx-auto px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-sm text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Бесплатное депонирование авторских прав, ноу-хау и любой информации с обеспечением доказательной базы для судов РФ и иностранных юрисдикций, маркетплейсов и других инстанций. Atoros хранит ваш архив в пяти независимых местах — ФНС, Яндекс.Диск, Google Drive, atoros.ru и торрент-сеть.
          </p>
        </div>
