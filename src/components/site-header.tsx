      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-8 h-16 flex items-center justify-between">
        <Link href="/" className="flex items-center gap-2 sm:gap-3 min-w-0">
          <Image
            ...
            height={70}
            priority
            className="atoros-logo h-10 sm:h-12 w-auto flex-shrink-0"
          />
          <span className="flex items-baseline gap-2 sm:gap-2.5 min-w-0">
            <span className="font-bold text-lg sm:text-xl text-blue-600 dark:text-cyan-400 whitespace-nowrap">
              Atoros<span className="font-normal">.</span>ru
            </span>
            <span
