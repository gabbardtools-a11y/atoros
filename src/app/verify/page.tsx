...
export const metadata = {
  title: 'Проверка свидетельства — Atoros',
  description: 'Проверка подлинности свидетельства о депонировании: по номеру, хеш-сумме или QR-коду. Без регистрации.',
  openGraph: {
    title: 'Проверка свидетельства Atoros',
    description: 'Проверьте подлинность свидетельства по номеру, хеш-сумме или QR-коду. Без регистрации.',
    type: 'website',
    locale: 'ru_RU',
    url: 'https://atoros.ru/verify',
    images: [{
      url: 'https://atoros.ru/og-verify.png',
      width: 1344,
      height: 768,
      alt: 'Проверка свидетельства — Atoros',
    }],
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Проверка свидетельства Atoros',
    description: 'По номеру, хеш-сумме или QR-коду. Без регистрации.',
    images: ['https://atoros.ru/og-verify.png'],
  },
};
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Проверка свидетельства</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Проверка подлинности свидетельства о депонировании: по номеру, хеш-сумме или QR-коду.</p>
