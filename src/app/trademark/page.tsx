...
export const metadata = { title: 'Регистрация товарных знаков — Atoros', description: 'Регистрация товарных знаков в Роспатенте. Защита брендов, логотипов, названий.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Регистрация товарных знаков</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Регистрация товарных знаков в Роспатенте. Защита брендов, логотипов, названий.</p>
