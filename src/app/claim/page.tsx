...
export const metadata = { title: 'Генератор претензий — Atoros', description: 'Автоматическая подготовка претензии о нарушении авторских прав на основе данных свидетельства о депонировании.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Генератор претензий</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Автоматическая подготовка претензии о нарушении авторских прав на основе данных свидетельства о депонировании.</p>
