...
export const metadata = { title: 'Регистрация авторских прав — Atoros', description: 'Нужна ли регистрация авторских прав в России? Как работает депонирование вместо регистрации.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Регистрация авторских прав</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Нужна ли регистрация авторских прав в России? Как работает депонирование вместо регистрации.</p>
