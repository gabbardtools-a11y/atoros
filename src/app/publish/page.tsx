...
export const metadata = { title: 'Публикация контента — Atoros', description: 'Публичная фиксация контента с подтверждением даты публикации. Размещение материалов с привязкой к автору.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Публикация контента</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Публичная фиксация контента с подтверждением даты публикации. Размещение материалов с привязкой к автору.</p>
