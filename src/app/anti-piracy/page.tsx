...
export const metadata = { title: 'Антипиратство — Atoros', description: 'Защита контента от пиратства: поиск копий, подготовка претензий, удаление незаконного контента.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Антипиратство</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Защита контента от пиратства: поиск копий, подготовка претензий, удаление незаконного контента.</p>
