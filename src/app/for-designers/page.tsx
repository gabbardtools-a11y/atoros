...
export const metadata = { title: 'Для дизайнеров — Atoros', description: 'Защита дизайна и графики: логотипы, интерфейсы, инфографика, иллюстрации. Депонирование работ дизайнеров.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Для дизайнеров</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">
          Защита дизайна и графики: логотипы, интерфейсы, инфографика, иллюстрации. Депонирование работ дизайнеров. Atoros фиксирует дату создания ваших работ одновременно в трёх независимых хранилищах — Яндекс.Диске, Google Drive и нашем сервере. Архив шифруется AES-256, вычисляются хеш-суммы MD5 и SHA-256. Любой может проверить ваше свидетельство без регистрации.
        </p>
