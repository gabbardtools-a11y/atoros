...
export const metadata = { title: 'Доказательство авторства для суда — Atoros', description: 'Как использовать свидетельство о депонировании в суде. Какие доказательства принимает суд по авторским правам.' };
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 max-w-[800px] w-full mx-auto px-6 py-16">
        <h1 className="text-3xl font-semibold text-foreground mb-4">Доказательство авторства для суда</h1>
        <p className="text-base text-muted-foreground leading-relaxed mb-6">Как использовать свидетельство о депонировании в суде. Какие доказательства принимает суд по авторским правам.</p>
